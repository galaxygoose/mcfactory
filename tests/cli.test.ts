...
describe('CLI', () => {
  ...
  describe('validateConfigCommand', () => {
    ...
    test('should validate provider configurations', () => {
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith(
        expect.stringContaining('✓ OpenAI provider configured')
      );
      expect(mockConsoleLog).toHaveBeenCalledWith(
        expect.stringContaining('✓ Anthropic provider configured')
      );
    });
    ...
    test('should warn about missing API keys', () => {
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith(
        expect.stringContaining('⚠ OpenAI provider missing apiKey')
      );
    });
  });
  ...
  describe('runPipelineCommand', () => {
    test('should run pipeline successfully', () => {
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith(
        expect.stringContaining(`🚀 Running pipeline: ${pipelineName}`)
      );
    });
